...
function AddEmployeeForm() {
  ...
  useEffect(() => {
    ...
    addEmployee(newEmployee).then((response) => console.log(" after adding ",response))
    reset();
  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.field}>
          ...
          <div className={styles.input}>
            <div style={{display: 'flex',justifyContent: 'flex-start', gap: '1rem'}}>
              <input type="radio" id="permanent" name="type" value="PERMANENT" {...register('type')} />
              <label htmlFor="permanent">Permanent</label>
              <input type="radio" id="contract" name= "type" value="CONTRACT" {...register('type')} /><label htmlFor="contract">Contract</label>
          </div>
          </div>
        </div>
        <div>
      ...
      {newEmployee && <p>Employee was added successfully. <a href="/">See the list of Employees</a></p>}
    </div>
